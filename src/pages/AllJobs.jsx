...
const AllJobs = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/jobs?size=${itemsPerPage}&page=${currentPage}`);
      console.log(data);
      return data;
    },
  });
  ...
  const { data: count = 0 } = useQuery({
    queryKey: ["count", itemsPerPage, currentPage],
    queryFn: async () => {
